  ...
  return (
    <div key={`${job.id}`} className="bg-white rounded-xl shadow-md relative">
            <div className="p-4">
              ...
              <button onClick={ () => setShowFullDescription((currentState => !currentState)) } className="text-indigo-500 mb-5 hover:text-indigo-600">{showFullDescription ? 'Less' : 'More'}</button>
